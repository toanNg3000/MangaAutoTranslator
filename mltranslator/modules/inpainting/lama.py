...
from mltranslator.utils.inpainting import (
    norm_img,
...
class LaMa(InpaintModel):
    ...
    def init_model(self, device, **kwargs):
        self.model = load_lama_model(model_path=f'{PROJECT_DIR}/mltranslator/models/inpainting/lama_large_512px.ckpt', device=device, large_arch=True)
